...
namespace ASEngine
{
    Quad2D::Quad2D(const vec2& size, mat3& transform, const Color& modulate)
    {   
    ...
    Quad2D::Quad2D(const vec2 &size, mat3 &transform, const Color &modulate, int hFrame, int hFrames, int vFrame, int vFrames)
    {
