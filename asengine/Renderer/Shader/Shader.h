...
#include "Renderer/VertexInput/VertexInput.h"
...
namespace ASEngine
{
    ...
    public:
        ...
        void Create(ResourceRef<ShaderSource> vertexSource, ResourceRef<ShaderSource> fragmentSource);
    ...
    protected:
        ...
        virtual void CreateImp(ResourceRef<ShaderSource> vertexSource, ResourceRef<ShaderSource> fragmentSource) = 0;
